...
class FmDataSourcePoolMapperXmlTest {

	@Test
	void loadsWithMyBatisParser() throws Exception {
		Configuration configuration = new Configuration();
		parse(configuration, "org/qifu/core/mapper/DB1Config.xml");
		parse(configuration, "org/qifu/fm/mapper/FmDataSourcePoolMapper.xml");
		assertTrue(configuration.hasStatement(
				"org.qifu.fm.mapper.FmDataSourcePoolMapper.selectByPrimaryKey"));
	}
