...
class FmProcessCategoryMapperXmlTest {

    @Test
    void loadsProcessCategoryMapperWithMyBatisParser() throws Exception {
        Configuration configuration = new Configuration();
        parse(configuration, "org/qifu/core/mapper/DB1Config.xml");
        parse(configuration, "org/qifu/fm/mapper/FmProcessCategoryMapper.xml");
        String namespace = "org.qifu.fm.mapper.FmProcessCategoryMapper.";
        for (String statement : new String[] {
                "selectByPrimaryKey", "selectListByParams", "findPage",
