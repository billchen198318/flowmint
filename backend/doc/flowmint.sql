...
('8d4a47c4-6e44-4fe3-94b4-79fcf70b3991','A01','2d939f65-b78e-454d-a48d-cdd538222d96','FM_PURCHASE_REQUEST','請購申請單',1,'DRAFT','正式請購申請表單，包含申請資訊、DataGrid 品項明細及自動金額彙總。','SYSTEM','2026-08-12 21:06:17.341',NULL,NULL);
...
('1b34cd84-8eeb-11f1-b571-5ba6ac7b8acc','A01','b7c74ae2-2133-4f33-a2d9-c7f87d5d5599','TEST01','測試流程01','測試類',NULL,1,'DRAFT','','admin','2026-08-03 11:26:25.012','admin','2026-08-03 11:37:55.851'),
('b68785e3-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986','FM_PURCHASE_APPROVAL','請購簽核流程','PURCHASE','PURCHASE_REQUEST',1,'DRAFT','請購單類別與風險專業會簽、採購、財務及金額核決流程草稿。','admin','2026-08-14 22:30:35.560','SYSTEM','2026-08-15 20:49:45.010');
...
('b687a2de-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'DRAFT','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<definitions xmlns=\"http://www.omg.org/spec/BPMN/20100524/MODEL\"\n             xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n             xmlns:bpmndi=\"http://www.omg.org/spec/BPMN/20100524/DI\"\n             xmlns:omgdc=\"http://www.omg.org/spec/DD/20100524/DC\"\n             xmlns:omgdi=\"http://www.omg.org/spec/DD/20100524/DI\"\n             targetNamespace=\"FlowMint\">\n  <process id=\"FM_PURCHASE_APPROVAL\" name=\"請購簽核流程\" isExecutable=\"true\">\n    <startEvent id=\"start\" name=\"開始\" />\n    <userTask id=\"departmentApproval\" name=\"申請部門主管簽核\" />\n    <inclusiveGateway id=\"professionalReviewSplit\" name=\"類別與風險分流\" default=\"flow_professional_default\" />\n    <userTask id=\"processReview\" name=\"製程審查\" />\n    <userTask id=\"productionEquipmentReview\" name=\"設備工程審查\" />\n    <userTask id=\"itReview\" name=\"資訊與資安審查\" />\n    <userTask id=\"qualityReview\" name=\"品質與檢測審查\" />\n    <userTask id=\"safetyReview\" name=\"工安審查\" />\n    <userTask id=\"environmentReview\" name=\"環保審查\" />\n    <userTask id=\"generalAffairsReview\" name=\"總務審查\" />\n    <inclusiveGateway id=\"professionalReviewJoin\" name=\"專業審查匯流\" />\n    <userTask id=\"purchaseReview\" name=\"採購部商務審查\" />\n    <userTask id=\"financeApproval\" name=\"財務與預算審查\" />\n    <exclusiveGateway id=\"gmGateway\" name=\"是否需總經理核決\" default=\"flow_gm_skip\" />\n    <userTask id=\"generalManagerApproval\" name=\"總經理核准\" />\n    <exclusiveGateway id=\"chairmanGateway\" name=\"是否需董事長核決\" default=\"flow_chairman_skip\" />\n    <userTask id=\"chairmanApproval\" name=\"董事長核准\" />\n    <endEvent id=\"end\" name=\"請購核准\" />\n\n    <sequenceFlow id=\"flow_start_department\" sourceRef=\"start\" targetRef=\"departmentApproval\" />\n    <sequenceFlow id=\"flow_department_split\" sourceRef=\"departmentApproval\" targetRef=\"professionalReviewSplit\" />\n\n    <sequenceFlow id=\"flow_to_process\" sourceRef=\"professionalReviewSplit\" targetRef=\"processReview\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.purchaseCategory == \"PRODUCTION_EQUIPMENT\"}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_to_equipment\" sourceRef=\"professionalReviewSplit\" targetRef=\"productionEquipmentReview\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.purchaseCategory == \"PRODUCTION_EQUIPMENT\" || flowmintFormData.purchaseCategory == \"QUALITY_EQUIPMENT\" || flowmintFormData.purchaseCategory == \"EHS_EQUIPMENT\" || flowmintFormData.purchaseCategory == \"CONSTRUCTION\" || flowmintFormData.involvesConstruction == true}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_to_it\" sourceRef=\"professionalReviewSplit\" targetRef=\"itReview\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.purchaseCategory == \"IT_EQUIPMENT\" || flowmintFormData.purchaseCategory == \"SOFTWARE_SERVICE\" || flowmintFormData.involvesInformationSystem == true || flowmintFormData.involvesCompanyData == true || flowmintFormData.involvesPersonalData == true}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_to_quality\" sourceRef=\"professionalReviewSplit\" targetRef=\"qualityReview\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.purchaseCategory == \"QUALITY_EQUIPMENT\" || flowmintFormData.purchaseCategory == \"RAW_MATERIAL\"}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_to_safety\" sourceRef=\"professionalReviewSplit\" targetRef=\"safetyReview\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.purchaseCategory == \"EHS_EQUIPMENT\" || flowmintFormData.purchaseCategory == \"CONSTRUCTION\" || flowmintFormData.involvesConstruction == true || flowmintFormData.involvesEhsRisk == true}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_to_environment\" sourceRef=\"professionalReviewSplit\" targetRef=\"environmentReview\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.purchaseCategory == \"EHS_EQUIPMENT\" || flowmintFormData.involvesEnvironmentalPermit == true}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_to_general\" sourceRef=\"professionalReviewSplit\" targetRef=\"generalAffairsReview\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.purchaseCategory == \"OFFICE_SUPPLIES\" || flowmintFormData.purchaseCategory == \"PROFESSIONAL_SERVICE\" || flowmintFormData.purchaseCategory == \"GENERAL\" || flowmintFormData.purchaseCategory == \"OTHER\"}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_professional_default\" sourceRef=\"professionalReviewSplit\" targetRef=\"professionalReviewJoin\" />\n\n    <sequenceFlow id=\"flow_process_join\" sourceRef=\"processReview\" targetRef=\"professionalReviewJoin\" />\n    <sequenceFlow id=\"flow_equipment_join\" sourceRef=\"productionEquipmentReview\" targetRef=\"professionalReviewJoin\" />\n    <sequenceFlow id=\"flow_it_join\" sourceRef=\"itReview\" targetRef=\"professionalReviewJoin\" />\n    <sequenceFlow id=\"flow_quality_join\" sourceRef=\"qualityReview\" targetRef=\"professionalReviewJoin\" />\n    <sequenceFlow id=\"flow_safety_join\" sourceRef=\"safetyReview\" targetRef=\"professionalReviewJoin\" />\n    <sequenceFlow id=\"flow_environment_join\" sourceRef=\"environmentReview\" targetRef=\"professionalReviewJoin\" />\n    <sequenceFlow id=\"flow_general_join\" sourceRef=\"generalAffairsReview\" targetRef=\"professionalReviewJoin\" />\n    <sequenceFlow id=\"flow_join_purchase\" sourceRef=\"professionalReviewJoin\" targetRef=\"purchaseReview\" />\n    <sequenceFlow id=\"flow_purchase_finance\" sourceRef=\"purchaseReview\" targetRef=\"financeApproval\" />\n    <sequenceFlow id=\"flow_finance_gm_gateway\" sourceRef=\"financeApproval\" targetRef=\"gmGateway\" />\n    <sequenceFlow id=\"flow_to_gm\" sourceRef=\"gmGateway\" targetRef=\"generalManagerApproval\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.projectTotalAmount > 300000}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_gm_skip\" sourceRef=\"gmGateway\" targetRef=\"end\" />\n    <sequenceFlow id=\"flow_gm_chairman_gateway\" sourceRef=\"generalManagerApproval\" targetRef=\"chairmanGateway\" />\n    <sequenceFlow id=\"flow_to_chairman\" sourceRef=\"chairmanGateway\" targetRef=\"chairmanApproval\">\n      <conditionExpression xsi:type=\"tFormalExpression\"><![CDATA[${flowmintFormData.projectTotalAmount > 500000}]]></conditionExpression>\n    </sequenceFlow>\n    <sequenceFlow id=\"flow_chairman_skip\" sourceRef=\"chairmanGateway\" targetRef=\"end\" />\n    <sequenceFlow id=\"flow_chairman_end\" sourceRef=\"chairmanApproval\" targetRef=\"end\" />\n  </process>\n\n  <bpmndi:BPMNDiagram id=\"FM_PURCHASE_APPROVAL_diagram\">\n    <bpmndi:BPMNPlane id=\"FM_PURCHASE_APPROVAL_plane\" bpmnElement=\"FM_PURCHASE_APPROVAL\">\n      <bpmndi:BPMNShape id=\"start_di\" bpmnElement=\"start\"><omgdc:Bounds x=\"100\" y=\"322\" width=\"36\" height=\"36\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"departmentApproval_di\" bpmnElement=\"departmentApproval\"><omgdc:Bounds x=\"190\" y=\"300\" width=\"120\" height=\"80\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"professionalReviewSplit_di\" bpmnElement=\"professionalReviewSplit\"><omgdc:Bounds x=\"370\" y=\"315\" width=\"50\" height=\"50\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"processReview_di\" bpmnElement=\"processReview\"><omgdc:Bounds x=\"480\" y=\"20\" width=\"120\" height=\"70\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"productionEquipmentReview_di\" bpmnElement=\"productionEquipmentReview\"><omgdc:Bounds x=\"480\" y=\"110\" width=\"120\" height=\"70\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"itReview_di\" bpmnElement=\"itReview\"><omgdc:Bounds x=\"480\" y=\"200\" width=\"120\" height=\"70\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"qualityReview_di\" bpmnElement=\"qualityReview\"><omgdc:Bounds x=\"480\" y=\"290\" width=\"120\" height=\"70\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"safetyReview_di\" bpmnElement=\"safetyReview\"><omgdc:Bounds x=\"480\" y=\"380\" width=\"120\" height=\"70\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"environmentReview_di\" bpmnElement=\"environmentReview\"><omgdc:Bounds x=\"480\" y=\"470\" width=\"120\" height=\"70\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"generalAffairsReview_di\" bpmnElement=\"generalAffairsReview\"><omgdc:Bounds x=\"480\" y=\"560\" width=\"120\" height=\"70\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"professionalReviewJoin_di\" bpmnElement=\"professionalReviewJoin\"><omgdc:Bounds x=\"670\" y=\"315\" width=\"50\" height=\"50\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"purchaseReview_di\" bpmnElement=\"purchaseReview\"><omgdc:Bounds x=\"780\" y=\"300\" width=\"120\" height=\"80\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"financeApproval_di\" bpmnElement=\"financeApproval\"><omgdc:Bounds x=\"960\" y=\"300\" width=\"120\" height=\"80\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"gmGateway_di\" bpmnElement=\"gmGateway\"><omgdc:Bounds x=\"1140\" y=\"315\" width=\"50\" height=\"50\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"generalManagerApproval_di\" bpmnElement=\"generalManagerApproval\"><omgdc:Bounds x=\"1250\" y=\"300\" width=\"120\" height=\"80\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"chairmanGateway_di\" bpmnElement=\"chairmanGateway\"><omgdc:Bounds x=\"1430\" y=\"315\" width=\"50\" height=\"50\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"chairmanApproval_di\" bpmnElement=\"chairmanApproval\"><omgdc:Bounds x=\"1540\" y=\"300\" width=\"120\" height=\"80\" /></bpmndi:BPMNShape>\n      <bpmndi:BPMNShape id=\"end_di\" bpmnElement=\"end\"><omgdc:Bounds x=\"1730\" y=\"322\" width=\"36\" height=\"36\" /></bpmndi:BPMNShape>\n    </bpmndi:BPMNPlane>\n  </bpmndi:BPMNDiagram>\n</definitions>','065fc32b412cc0bc875af38eb8b3fa80a49f7ff23b286189f0634f17d7b325c5',NULL,NULL,NULL,NULL,'admin','2026-08-14 22:30:35.561','admin','2026-08-14 22:31:42.449');
...
('b688edd6-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'departmentApproval',1,'INITIATOR_ORG_HEAD','{}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688efc9-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'processReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede333-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f138-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'productionEquipmentReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede3c0-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f194-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'itReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede3d0-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f1de-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'qualityReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede3df-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f226-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'safetyReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede3ee-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f271-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'environmentReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede3fe-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f2b4-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'generalAffairsReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede40c-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f30e-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'purchaseReview',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede42a-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f359-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'financeApproval',1,'APPROVAL_GROUP','{\"approvalGroupId\": \"4cede439-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f3a0-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'generalManagerApproval',1,'APPROVAL_AUTHORITY','{\"approvalAuthorityId\": \"eec85023-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL),
('b688f3f0-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'chairmanApproval',1,'APPROVAL_AUTHORITY','{\"approvalAuthorityId\": \"eec856db-97eb-11f1-a6a7-005056c00001\"}',NULL,100,'ACTIVE','admin','2026-08-14 22:30:35.568',NULL,NULL);
...
('b68891b4-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'departmentApproval','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b688963f-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'processReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b6889712-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'productionEquipmentReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b6889753-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'itReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b6889792-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'qualityReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b68897cc-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'safetyReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b6889806-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'environmentReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b688983a-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'generalAffairsReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b6889885-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'purchaseReview','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b68898bb-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'financeApproval','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b68898ef-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'generalManagerApproval','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL),
('b6889925-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'chairmanApproval','2d939f65-b78e-454d-a48d-cdd538222d96',1,'{\"default\": \"READ\", \"fields\": {}}','admin','2026-08-14 22:30:35.567',NULL,NULL);
...
('b688aa57-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'departmentApproval','申請部門主管簽核','ASSIGNEE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688ae40-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'processReview','製程審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688af01-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'productionEquipmentReview','設備工程審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',72,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688af4d-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'itReview','資訊與資安審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688af92-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'qualityReview','品質與檢測審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688afd2-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'safetyReview','工安審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688b025-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'environmentReview','環保審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688b061-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'generalAffairsReview','總務審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688b09c-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'purchaseReview','採購部商務審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688b0d7-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'financeApproval','財務與預算審查','CANDIDATE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',48,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688b113-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'generalManagerApproval','總經理核准','ASSIGNEE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',72,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
('b688b14f-97ec-11f1-a6a7-005056c00001','A01','cdbaf0cb-197e-4c42-b03d-402e7dd71986',1,'chairmanApproval','董事長核准','ASSIGNEE','SKIP_TO_NEXT','MERGE_CONSECUTIVE','Y','Y','N','N','ON_REJECT_RETURN',72,8,'admin','2026-08-14 22:30:35.568','admin','2026-08-14 22:31:42.455'),
...
-- Dump completed on 2026-08-15 21:46:46
